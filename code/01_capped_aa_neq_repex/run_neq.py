...
# Save positions
with open(os.path.join(args.dir, f"{i}_{args.phase}_forward_old.npy"), 'wb') as f:
    np.save(f, forward_traj_old)
with open(os.path.join(args.dir, f"{i}_{args.phase}_forward_new.npy"), 'wb') as f:
    np.save(f, forward_traj_new)
with open(os.path.join(args.dir, f"{i}_{args.phase}_reverse_old.npy"), 'wb') as f:
    np.save(f, reverse_traj_old)
with open(os.path.join(args.dir, f"{i}_{args.phase}_reverse_new.npy"), 'wb') as f:
