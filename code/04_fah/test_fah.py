...
with open("/data/chodera/zhangi/perses_benchmark/fah/13413/RUNS/RUN3911/integrator.xml", 'r') as f:
    integrator = XmlSerializer.deserialize(f.read())

# Deserialize system file 
import bz2
with bz2.open("/data/chodera/zhangi/perses_benchmark/fah/13413/RUNS/RUN3911/system.xml.bz2", 'rb') as f:
...
import bz2
with bz2.open("/data/chodera/zhangi/perses_benchmark/fah/13413/RUNS/RUN3911/state.xml.bz2", 'rb') as infile:
