...
with open(os.path.join(args.outdir, f"{dir_num}_{args.phase}_{args.endstate}_positions.pickle"), 'wb') as f:
    pickle.dump(positions, f)

with open(os.path.join(args.outdir, f"{dir_num}_{args.phase}_{args.endstate}_energies.pickle"), 'wb') as f:
