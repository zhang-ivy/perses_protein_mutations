...
suffix = 'run'; selection = 'not water'; checkpoint_interval = 10; n_states = 22; n_cycles = 2500
...
hss.setup(n_states=n_states, temperature=300*unit.kelvin, storage_file=reporter, lambda_protocol=lambda_protocol, unique_positions=all_pos[:22])
hss.extend(n_cycles)