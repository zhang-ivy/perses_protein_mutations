...
# Define file paths
template_file = "/home/zhangi/choderalab/perses_benchmark/perses_protein_mutations/code/20_counterion_fix/run_rest2_template.sh"
out_dir = "/data/chodera/zhangi/perses_benchmark/neq/16/"
	...
	for i, phase in enumerate(phases):
		...
		for line in lines_out:
		    if "#BSUB -W" in line:
		        ...
		        job_range = "1-2" if phase == 'apo' or phase == 'solvent'  else "3-4"
