...
parser.add_argument('chain_to_mutate', type=int)
parser.add_argument('residue_to_mutate', type=int)
...
for atom in htf.hybrid_topology.atoms:
    if atom.residue.name not in ('WAT', 'HOH', 'NA', 'CL'):
        if atom.residue.index != args.residue_to_mutate and atom.residue.chain.index == args.chain_to_mutate:
