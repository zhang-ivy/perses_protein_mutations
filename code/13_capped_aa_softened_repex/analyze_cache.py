...
with open(os.path.join(out_dir, f"{i}_vacuum_{args.endstate}.pickle"), 'rb') as f:
    htf = pickle.load(f)

dihedrals, n_iter = get_dihedrals_all_replicas(i, aa, length, out_dir, htf, [13, 10, 7, 6], [12, 10, 7, 6])
