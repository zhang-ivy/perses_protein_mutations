...
# Load RepartitionedHybridTopologyFactory
i = os.path.basename(os.path.dirname(args.dir))
path = os.path.join(args.dir, f"{i}_{phase}_{state}.pickle")
_logger.info(f"Loading factories from path: {path}")
...
# Load rest factory
with open(os.path.join(args.dir, f"{i}_{phase}_{state}_rest.pickle"), "rb") as f:
...
_logger.info(f"Create thermostates")
