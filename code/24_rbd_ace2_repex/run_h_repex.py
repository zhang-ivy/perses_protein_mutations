...
selection = 'not water'; checkpoint_interval = 10; n_states = 34; n_cycles = 5000 
...
lambda_schedule = list(np.linspace(0.0,0.4, 14)) +  [0.5] + list(np.linspace(0.6,0.7, 6)) + list(np.linspace(0.71, 0.8, 6)) + list(np.linspace(0.81, 1.0, 7))
