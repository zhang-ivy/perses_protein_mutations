...
simulation.create(thermodynamic_states=thermodynamic_states, sampler_states=states.SamplerState(testsystem.positions, box_vectors=system.getDefaultPeriodicBoxVectors()), storage=reporter)
