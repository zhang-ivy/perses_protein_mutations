...
stream = open("test_analyze.yaml", 'r')
dictionary = yaml.load(stream)

# Define file paths
template_file = "/home/zhangi/choderalab/perses_benchmark/perses_protein_mutations/code/22_rbd_ace2_rest/analyze_rest2_template.sh"
