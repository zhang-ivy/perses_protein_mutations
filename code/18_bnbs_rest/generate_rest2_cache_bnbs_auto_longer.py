...
water_atoms = md.compute_neighbors(traj, 0.8, query_indices, haystack_indices=list(range(1441, htf.hybrid_topology.n_atoms)))[0]
...
# Set up sampler
move = mcmc.GHMCMove(timestep=4.0*unit.femtoseconds, n_steps=25000)
simulation = multistate.ReplicaExchangeSampler(mcmc_moves=move, number_of_iterations=args.length*10)
