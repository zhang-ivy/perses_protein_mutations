...
stream = open("test_wait.yaml", 'r')
dictionary = yaml.load(stream)

# Define file paths
template_file = "/home/zhangi/choderalab/perses_benchmark/perses_protein_mutations/code/23_rbd_ace2_neq/run_all_neq_distrib_wait_template.sh"
